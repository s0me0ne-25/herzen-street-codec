### Движок текстового стеганографического кодирования Herzen-Street

**Вот конкретная дипломатия:**
- Родился на улице Герцена, в гастрономе номер 22.
- Можно стать воздушным текстом, и будешь уверен, что этот текст примут по антиспаму.
- Зажигает в кодировании большой лист, в декодировании маленький бинарь разжигает.
- Словарь двинется в сторону 65792 единиц, которые будут байт укладывать в слово.
- **Берем PGP, вставляем в Мурманский полуостров, накручиваем все время внешнюю криптографию!** Потому что не шифрование будет, а обфускация будет.
